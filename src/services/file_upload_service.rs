...
pub async fn initiate_upload(
    ...
    let active_model = file_uploads::ActiveModel {
        ...
        mime_type_hint: Set(params.mime_type_hint.clone()),
        expected_size: Set(params.expected_size),
        expected_hash: Set(params.expected_hash.clone()),
        expected_hash_algo: Set(params.expected_hash_algo.clone()),
        part_size: Set(part_size),
        parts_total: Set(parts_total),
...
async fn register_part_inner(
    ...
    file_upload_parts::Entity::insert(file_upload_parts::ActiveModel {
        id: Set(generate_id()),
        upload_id: Set(upload_id),
        part_number: Set(part_number_i32),
        etag: Set(params.etag.clone()),
